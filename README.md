...
Даны вершины двух треугольников в трехмерном пространстве (a1, b1, c1) и (a2, b2, c2), нужно определить, пересекаются они или нет. Набросок решения на C++ с алгоритмом решения:
``` cpp
